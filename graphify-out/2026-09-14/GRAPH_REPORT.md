...
## Corpus Check
- 466 files · ~1,732,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4635 nodes · 9220 edges · 343 communities (293 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.83)
...
8. `stepCombat()` - 33 edges
9. `BattleCanvas()` - 32 edges
...
### Community 0 - "add"
Cohesion: 0.06
Nodes (102): aerialAttack(), base(), chargeAttack(), doubleKick(), flyingKick(), heavyKick(), jumpAttack(), peckAttack() (+94 more)
...
Cohesion: 0.07
Nodes (36): aerialPose(), AttackPose, attackPoseFor(), attackStateForMove(), BattleCanvas(), bodyAttackPose(), clamp(), FighterVisual (+28 more)

### Community 3 - "liveCommentary.ts"
Cohesion: 0.11
Nodes (19): LivePage(), handleImpact(), handleReplayEnd(), COMMAND_FOLLOWED_LABEL, commentaryForBoutStart(), commentaryForImpact(), commentaryForResult(), CommentaryLine (+11 more)

### Community 4 - "resolution.ts"
Cohesion: 0.11
Nodes (29): adaptationCounterBonus(), experienceConfidenceBonus(), fatigueDecisionPenalty(), fatigueStatMultiplier(), momentumDelta(), clampPosition(), deriveContextState(), DISTANCE_ORDER (+21 more)

### Community 5 - "seed-deep-red-black-roster.ts"
Cohesion: 0.09
Nodes (40): POST(), clamp(), COLOR_KEYS, driftRgb(), hasAllele(), hexToRgb(), hslToRgb(), inheritColorHex() (+32 more)
...
Cohesion: 0.09
Nodes (36): BREED_IDS, BREED_PRESETS, BreedId, BreedPreset, pickRandomBreed(), createChicken(), CreateChickenInput, cryptoSafeId() (+28 more)

### Community 8 - "combat-v2/engine.ts"
Cohesion: 0.13
Nodes (43): aerialImpact(), aerialPhase(), clamp(), COMBAT_DT, COMBAT_TICK_RATE, COMMAND_BUFFER_TICKS, COMMAND_COOLDOWN_TICKS, quantize() (+35 more)
...
### Community 12 - "facilities/config.ts"
Cohesion: 0.10
Nodes (19): TrainingProgramGrid(), uiCategory(), INTENSITIES, signed(), TrainingSetupPanel(), BEHAVIOR, PRIMARY, ProgramInput (+11 more)
...
Cohesion: 0.11
Nodes (26): Overview(), band(), BAR_TONE, ConditionMonitor(), inverseBand(), PILL_TONE, Tone, CoachReport() (+18 more)
...
Cohesion: 0.10
Nodes (27): POST(), declineMultiplier(), deriveLifeStage(), totalExperience(), VETERAN_STAGES, veteranExperienceBonus(), seedChicken(), statBlock() (+19 more)
...
Cohesion: 0.13
Nodes (23): POST(), BetBody, POST(), POST(), ResolveBody, POST(), GET(), BATTLE_WIN_CREDITS (+15 more)
...
Cohesion: 0.21
Nodes (12): POST(), seedChicken(), statBlock(), seedChicken(), statBlock(), REDISTRIBUTE_CREDITS_PER_POINT, STATUS_BY_CODE, TrainingError (+4 more)
...
Cohesion: 0.15
Nodes (18): updateOpponentModel(), clampFatigue(), fatigueAccuracyPenalty(), fatigueGain(), fatigueRecoveryPerTurn(), applyMentalState(), clamp01(), deriveMentalState() (+10 more)

### Community 30 - "chicken/[chickenId]/page.tsx"
Cohesion: 0.09
Nodes (34): BodyRegion, Career(), ChickenApiPayload, ChickenDetailPageContent(), handleAgeUp(), handleRest(), handleRetire(), refreshFrom() (+26 more)
...
Cohesion: 0.11
Nodes (32): PROGRAM_BY_STAT, DevAction, POST(), POST(), GET(), POST(), POST(), GET() (+24 more)
...
Cohesion: 0.29
Nodes (7): createInjuryRecord(), CRITICAL_HIT_ZONES, deterministicId(), RECOVERY_TURNS, Rng, SEVERITY_LABELS, InjurySeverity

### Community 38 - "lib/training/types.ts"
Cohesion: 0.12
Nodes (29): TRAINING_GYM_LEVELS, calculateTrainingProjection(), clamp(), PRIMARY_BY_CATEGORY, TRAINING_GAIN_MULTIPLIER, trainingEffectiveness(), potentialBand(), previewTrainingSession() (+21 more)
...
Cohesion: 0.13
Nodes (3): CoopEnvironment(), useYardTexture(), mulberry32()
...
Cohesion: 0.08
Nodes (23): BattlePage(), CanonicalStart, Phase, NEXT, PostFightOverlay(), PostFightState, Props, signed() (+15 more)

### Community 45 - "liveSession.ts"
Cohesion: 0.21
Nodes (8): CoachingCommand, fighterStrength(), gainExperience(), rollCriticalInjury(), commandMode(), LiveCombatV2Session, modeCommand(), createCombatRng()

### Community 46 - "combat/service.ts"
Cohesion: 0.09
Nodes (41): POST(), POST(), POST(), GET(), POST(), advanceSession(), AWAKENING_TYPES, CombatServiceError (+33 more)

### Community 47 - "BattleSession"
Cohesion: 0.17
Nodes (10): POST(), BattleCanvasProps, generateBattleAnalysis(), CombatInstruction, rollInjurySeverity(), BattleSession, simulateBattle(), createSparSession() (+2 more)
...
### Community 49 - "ChickenPhysicsRig.tsx"
Cohesion: 0.17
...
Cohesion: 0.16
Nodes (23): GET(), POST(), POST(), GET(), hasActiveInjury(), STATUS, TournamentError, TournamentErrorCode (+15 more)
...
Cohesion: 0.09
Nodes (30): Phase, TournamentView, CircuitStep, eligibility(), TournamentCircuitPage(), TournamentBracket(), TournamentAction(), TournamentShell() (+22 more)
...
### Community 60 - "ChickenViewer.tsx"
Cohesion: 0.19
...
Cohesion: 0.07
Nodes (46): POST(), POST(), POST(), POST(), POST(), GET(), GET(), POST() (+38 more)

### Community 66 - "spar/[sessionId]/step/route.ts"
Cohesion: 0.24
Nodes (8): POST(), StepBody, autoCoachPolicy(), CoachFn, CoachObservation, endSparSession(), getSparSession(), sessions

### Community 67 - "seed-strategy-fighter-roster.ts"
Cohesion: 0.07
Nodes (45): Rng, statBlock(), seed(), context(), BONUS_EV_ON_BREAKTHROUGH, BREAKTHROUGH_BASE_CHANCE, BREAKTHROUGH_MILESTONE_BONUS, checkOvertrainedTrigger() (+37 more)

### Community 68 - "VillageView.tsx"
Cohesion: 0.18
Nodes (9): CoopHUD(), CoopMode, CoopIcon(), IconName, PATHS, EggGrid(), CoopPage(), VillageView() (+1 more)
...
Cohesion: 0.18
Nodes (6): BattleDirector, BattleHudVisibility, NEUTRAL, phaseState(), PresentationIntensity, EngagementPhase
...
### Community 79 - "continuousCombat.test.ts"
Cohesion: 0.11
Nodes (26): CollisionDebugVolumes(), combatEvolutionSnapshot, bodyClearanceRadius(), bodyRadius(), HitZone, hurtboxes(), HurtboxOffset, hurtboxOffsets() (+18 more)

### Community 82 - "CanonicalCombatRuntime"
Cohesion: 0.19
Nodes (9): CanonicalCombatRuntime, canonicalEventType(), CoachingCommand, commandMode(), queueCommand(), fighterA, fighterB, run() (+1 more)
...
Cohesion: 0.10
Nodes (29): PX_TO_WORLD, DEFAULT_TARGET, TrainingCameraController(), Scene(), TrainingStation(), blankAnim(), movement(), SparringPair() (+21 more)
...
### Community 111 - "CombatPresentationController"
Cohesion: 0.19
...
Cohesion: 0.07
Nodes (24): CommandCardDef, CommandFeedback, CommandWheel(), SEGMENTS, ACTIONS, AWAKENING_DURATION_SECONDS, AWAKENING_DURATION_TICKS, AWAKENING_MODIFIERS (+16 more)
...
Cohesion: 0.05
Nodes (43): Phase, StartResponse, ScreenAnchor, animation, AuthoritativeBattleStage, AuthoritativeContinuousBattle(), AuthoritativeView, AWAKENING_LABELS (+35 more)
...
Cohesion: 0.09
Nodes (20): ArenaEnvironment(), ArenaGround(), useDirtTexture(), ArenaPhysics(), AGGRESSIVE_TELLS, ANIM_PX_TO_WORLD, BattleStage3D(), CameraCue (+12 more)

### Community 150 - "pve/service.ts"
Cohesion: 0.12
Nodes (19): getBoss(), previousBossId(), PVE_BOSS_LIST, PVE_BOSSES, BossFightEntry, endBossFightSession(), getBossFightSession(), sessions (+11 more)
...
Cohesion: 0.26
Nodes (11): FighterHud(), FighterPlate(), MatchupScreen(), mockOpponentRecord(), RANK_TITLE, rankTitle(), STAT_LABEL, StatCompareRow() (+3 more)

### Community 153 - "behavior.ts"
Cohesion: 0.20
Nodes (17): ARCHETYPE_PROFILES, DecisionContext, Rng, emptyExperience(), emptyOpponentModel(), makeCombatantState(), MAX_HEALTH, AGGRESSION_ACTIONS (+9 more)
...
Cohesion: 0.21
Nodes (9): chooseAction(), scoreAction(), inactivityPressureBonus(), shouldForceEngagement(), STALEMATE_TURNS, STYLE_POLICIES, StylePolicy, styleWeight() (+1 more)
...
### Community 166 - "combat-v2/tells.ts"
Cohesion: 0.21
Nodes (11): FighterPosture, Candidate, candidates(), distance(), RAMP_TICKS, READ_TELL_TYPES, TELL_LIFETIME, TELL_META (+3 more)
...
### Community 170 - "combat/actions.ts"
Cohesion: 0.24
Nodes (8): ACTION_DEFINITIONS, ALL_ACTIONS, legalActions(), LOW_COMMITMENT_ACTIONS, actionDurationMs(), exchangeDurationMs(), PhysicalProfile, CombatActionDefinition
...
Cohesion: 0.10
Nodes (26): OffspringPreview(), pairingNotes(), projectedRange(), RARITY_BAR, STAT_META, BreedPageContent(), ParentCard(), ROLE_COLOR (+18 more)
...
### Community 198 - "momentum.ts"
Cohesion: 0.31
Nodes (7): clampMomentum(), decayMomentum(), MOMENTUM_MAX, MOMENTUM_MIN, MOMENTUM_RISK_NUDGE_CAP, MomentumEvent, momentumRiskNudge()
...
Cohesion: 0.15
Nodes (22): ChickenCard(), CoopSelectionPanel(), ManageView(), recommendation(), filterChickens(), isChampion(), AgeUpChicken, AgeUpRequirement (+14 more)

### Community 207 - "market/page.tsx"
Cohesion: 0.25
Nodes (9): handleSell(), placeBet(), fetchMarket(), MarketPage(), handleBuy(), SEX_ICON, PageHeader(), setPlayerCredits() (+1 more)
...
Cohesion: 0.16
Nodes (18): TrainingScene3D(), ERROR_MESSAGES, FacilityViewDTO, formatRemaining(), remainingMilliseconds(), SessionDTO, TrainingChicken, TrainingChickenDevelopment (+10 more)

### Community 217 - "ChickenModel.tsx"
Cohesion: 0.11
Nodes (24): applyGrowthStageOverride(), applyHenOverride(), applyProportions(), applyRuntimeNeutralPose(), applyVisualTraits(), AwakeningAura(), BONE_PARENT, ChickenModel() (+16 more)

### Community 218 - "lib/types.ts"
Cohesion: 0.07
Nodes (31): CALM, IRON_STAMINA, pickWeightedTrait(), RARITY_WEIGHT, Rng, TRAIT_POOL, BattleLogEntry, BattleResult (+23 more)
...
Cohesion: 0.21
Nodes (10): clamp01(), escalateBoss(), EscalationDelta, EscalationResult, escalationTier(), PveOpponentHistorySummary, deriveCampaignEvents(), NewCampaignEvent (+2 more)
...
Cohesion: 0.13
Nodes (26): randomStatBlock(), applyFightOutcome(), clamp01(), deriveBehaviorProfile(), driftBehaviorProfile(), hasTrait(), withNpcAwakening(), finalHealthPercent() (+18 more)
...
### Community 301 - "simulateFight"
Cohesion: 0.14
Nodes (18): simulateFight(), clamp(), estimateOdds(), LiveOdds, toOdds(), ActionTally, buildFighter(), formatMix() (+10 more)

### Community 302 - "coopFilters.ts"
Cohesion: 0.24
Nodes (7): CoopFilters(), STATUS_OPTIONS, CoopFilterState, DEFAULT_COOP_FILTERS, NO_FILTER, ChickenSex, ChickenStatus
...
### Community 315 - "HitZone"
Cohesion: 0.22
Nodes (7): CombatEvent, calculateStagger(), LEG_ZONES, STAGGER_THRESHOLDS, StaggerContext, CombatContextState, HitZone

### Community 316 - "liveBattleSessions.ts"
Cohesion: 0.32
...
Cohesion: 0.10
Nodes (24): recoverCondition(), tickInjuryRecovery(), createIllness(), ILLNESS_LABELS, nextId(), RECOVERY_CYCLES, Rng, rollIllness() (+16 more)

### Community 318 - "effectiveStat"
Cohesion: 0.16
Nodes (16): physicalDossier(), effectiveCombatStat(), effectiveStat(), mutationStatMultiplier(), permanentInjuryStatMultiplier(), getMutationDefinition(), MUTATION_IDS, MutationDefinition (+8 more)
...
- **Why does `Chicken` connect `getOrCreatePlayer` to `BattleCanvas.tsx`, `chickenGenerator.ts`, `status.ts`, `ContinuousBattle.tsx`, `coopVillage.ts`, `BattleStage3D.tsx`, `training.ts`, `fight/[chickenId]/page.tsx`, `MatchupScreen.tsx`, `marketplace.ts`, `behavior.ts`, `pve/service.ts`, `simulator.ts`, `chicken/[chickenId]/page.tsx`, `live/page.tsx`, `facilities/service.ts`, `lib/training/types.ts`, `thumbnailCache.ts`, `combat.ts`, `battleReport.ts`, `liveSession.ts`, `rarity.ts`, `BattleSession`, `combat/service.ts`, `ChickenPhysicsRig.tsx`, `coopFilters.ts`, `simulateFight`, `tournament/service.ts`, `tournament.ts`, `medical/service.ts`, `ChickenViewer.tsx`, `medical.test.ts`, `effectiveStat`, `evolution.ts`, `seed-strategy-fighter-roster.ts`, `VillageView.tsx`, `growth.ts`, `continuousCombat.test.ts`, `CanonicalCombatRuntime`, `TrainingGymShell.tsx`, `ChickenModel.tsx`, `lib/types.ts`, `TrainingVisualizationController.tsx`, `combat-v2/types.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `AudioEngine` connect `AudioEngine` to `BattleCanvas.tsx`, `audioEngine.test.ts`, `ContinuousBattle.tsx`?**
...
- **Should `add` be split into smaller, more focused modules?**
  _Cohesion score 0.056140032650099765 - nodes in this community are weakly interconnected._
