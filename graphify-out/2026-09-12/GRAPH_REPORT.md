# Graph Report - rooster-arena  (2026-09-11)

## Corpus Check
- 425 files · ~1,579,918 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3854 nodes · 8069 edges · 258 communities (214 shown, 39 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 76 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `49099160`
...
1. `getOrCreatePlayer()` - 107 edges
2. `Chicken` - 95 edges
3. `prisma` - 57 edges
4. `add()` - 50 edges
5. `StatBlock` - 39 edges
6. `effectiveStat()` - 35 edges
7. `GENETIC_STAT_KEYS` - 34 edges
8. `BattleCanvas()` - 33 edges
9. `stepCombat()` - 29 edges
10. `ChickenDetailPageContent()` - 28 edges
...
### Community 0 - "attacks.ts"
Cohesion: 0.24
Nodes (34): base(), chargeAttack(), doubleKick(), flyingKick(), heavyKick(), jumpAttack(), peckAttack(), quickKick() (+26 more)

### Community 2 - "BattleCanvas.tsx"
Cohesion: 0.07
Nodes (35): aerialPose(), AttackPose, attackPoseFor(), attackStateForMove(), BattleCanvas(), bodyAttackPose(), clamp(), FighterVisual (+27 more)

### Community 3 - "battleReport.ts"
Cohesion: 0.11
Nodes (27): POST(), POST(), StepBody, BetBody, POST(), POST(), ResolveBody, POST() (+19 more)

### Community 4 - "resolution.ts"
Cohesion: 0.11
Nodes (28): adaptationCounterBonus(), experienceConfidenceBonus(), fatigueDecisionPenalty(), momentumDelta(), clampPosition(), deriveContextState(), DISTANCE_ORDER, POSITION_MAX (+20 more)

### Community 5 - "seed-deep-red-black-roster.ts"
Cohesion: 0.09
Nodes (39): POST(), clamp(), COLOR_KEYS, driftRgb(), hasAllele(), hexToRgb(), hslToRgb(), inheritColorHex() (+31 more)
...
Cohesion: 0.09
Nodes (35): POST(), BREED_IDS, BREED_PRESETS, BreedId, BreedPreset, pickRandomBreed(), createChicken(), CreateChickenInput (+27 more)

### Community 8 - "combat-v2/engine.ts"
Cohesion: 0.23
Nodes (28): aerialImpact(), aerialPhase(), clamp(), quantize(), awakeningPower(), commandAlignment(), decide(), distance() (+20 more)
...
### Community 16 - "ChickenDetailPageContent"
Cohesion: 0.19
Nodes (12): ChickenDetailPageContent(), handleAgeUp(), handleRest(), handleRetire(), refreshFrom(), normalizeChickenPayload(), developmentPercent(), getMutationDefinition() (+4 more)

### Community 17 - "status.ts"
Cohesion: 0.12
Nodes (24): Overview(), band(), BAR_TONE, ConditionMonitor(), inverseBand(), PILL_TONE, Tone, CoachReport() (+16 more)
...
### Community 22 - "ContinuousBattle.tsx"
Cohesion: 0.09
Nodes (24): ArenaEnvironment(), ArenaGround(), useDirtTexture(), ArenaPhysics(), ANIM_PX_TO_WORLD, BattleStage3D(), DirectedCamera(), heuristicCue() (+16 more)
...
Cohesion: 0.27
Nodes (11): GET(), generateListing(), listingToChicken(), MARKET_STOCK_SIZE, MarketListingRow, sellPrice(), seedChicken(), seedListing() (+3 more)
...
### Community 27 - "training.ts"
Cohesion: 0.07
Nodes (42): declineMultiplier(), deriveLifeStage(), totalExperience(), VETERAN_STAGES, veteranExperienceBonus(), BONUS_EV_ON_BREAKTHROUGH, BREAKTHROUGH_BASE_CHANCE, BREAKTHROUGH_MILESTONE_BONUS (+34 more)

### Community 28 - "liveCommentary.ts"
Cohesion: 0.09
Nodes (26): handleImpact(), handleReplayEnd(), clampStepDelay(), COMMAND_LABEL, Phase, Snapshot, SparPage(), StartResponse (+18 more)

### Community 29 - "simulator.ts"
Cohesion: 0.11
Nodes (25): generateBattleAnalysis(), updateOpponentModel(), clampFatigue(), fatigueAccuracyPenalty(), fatigueGain(), fatigueRecoveryPerTurn(), fatigueStatMultiplier(), inactivityPressureBonus() (+17 more)

### Community 30 - "chicken/[chickenId]/page.tsx"
Cohesion: 0.10
Nodes (27): BodyRegion, Career(), ChickenApiPayload, Combat(), Development(), EXPERIENCE_LABEL, Genetics(), Meter() (+19 more)
...
Cohesion: 0.12
Nodes (33): PROGRAM_BY_STAT, DevAction, POST(), POST(), GET(), POST(), POST(), GET() (+25 more)
...
Cohesion: 0.12
Nodes (25): FighterAnim, ChickenPhysicsHandle, ChickenPhysicsRig, ChickenPhysicsRigProps, KNOCKBACK_IMPULSE, KNOCKDOWN_RECOVER_MS, scaledRecoveryMs(), scaleSpec() (+17 more)

### Community 37 - "medical.test.ts"
Cohesion: 0.11
Nodes (23): recoverCondition(), CRITICAL_HIT_ZONES, RECOVERY_TURNS, Rng, SEVERITY_LABELS, tickInjuryRecovery(), createIllness(), ILLNESS_LABELS (+15 more)

### Community 38 - "behavior.ts"
Cohesion: 0.11
Nodes (28): ARCHETYPE_PROFILES, chooseAction(), clamp01(), DecisionContext, deriveBehaviorProfile(), driftBehaviorProfile(), hasTrait(), Rng (+20 more)

### Community 39 - "dependencies"
Cohesion: 0.12
Nodes (17): next, dependencies, next, @prisma/client, react, react-dom, @react-three/drei, @react-three/fiber (+9 more)

### Community 40 - "spar/start/route.ts"
Cohesion: 0.17
Nodes (14): POST(), StepBody, POST(), StartBody, BattleCanvasProps, PlayerCommand, BattleSession, MAX_TURNS (+6 more)

### Community 41 - "MatchupScreen.tsx"
Cohesion: 0.26
Nodes (12): FighterHud(), FighterPlate(), MatchupScreen(), mockOpponentRecord(), RANK_TITLE, rankTitle(), seededRng(), STAT_LABEL (+4 more)

### Community 42 - "coopVillage.ts"
Cohesion: 0.19
Nodes (14): CoopChicken(), CoopHabitat(), CoopWorld(), COMPOUND_SLOTS, getVillageSlot(), habitatStyle, hashString(), personalityModifiers (+6 more)
...
Cohesion: 0.13
Nodes (14): FightResponse, Phase, NEXT, PostFightOverlay(), PostFightState, Props, signed(), STEP_DELAY (+6 more)

### Community 45 - "seed-strategy-fighter-roster.ts"
Cohesion: 0.09
Nodes (25): BATTLE_SCARRED_TRAIT, evaluateBattleTraits(), hasTrait(), severeInjuryCount(), VETERAN_TRAIT, Rng, XP_PER_SESSION, XP_POOLS_BY_CATEGORY (+17 more)
...
Cohesion: 0.21
Nodes (15): POST(), GET(), hasActiveInjury(), STATUS, TournamentError, TournamentErrorCode, advanceRound(), AdvanceRoundResult (+7 more)
...
Cohesion: 0.14
Nodes (19): TournamentBracket(), fakeResult(), playerAlwaysLosesFight(), playerAlwaysWinsFight(), advanceEntrantChicken(), BASE_PLACEMENT_TOKENS, BracketEntrant, createTournament() (+11 more)
...
Cohesion: 0.15
Nodes (17): OffspringPreview(), pairingNotes(), projectedRange(), RARITY_BAR, STAT_META, ROLE_COLOR, STAT_LABEL, computeOffspringOdds() (+9 more)
...
Cohesion: 0.10
Nodes (18): GET(), CATEGORY_TO_TRAINING, experienceInsights(), matchupInsight(), TrainingInsight, BattleLogEntry, BattleResult, Bet (+10 more)
...
Cohesion: 0.08
Nodes (33): POST(), POST(), POST(), POST(), POST(), POST(), GET(), POST() (+25 more)

### Community 66 - "command.ts"
Cohesion: 0.13
Nodes (19): clamp01(), COMMAND_ACTIVE_TURNS, COMMAND_POINT_REGEN_TURNS, COMMAND_POINTS_MAX, COMMAND_TARGET_ACTIONS, commandActionModifier(), commandTargetsAction(), complianceFactor() (+11 more)

### Community 67 - "simulateFight"
Cohesion: 0.14
Nodes (18): simulateFight(), clamp(), estimateOdds(), LiveOdds, toOdds(), ActionTally, buildFighter(), formatMix() (+10 more)

### Community 68 - "growth.ts"
Cohesion: 0.16
Nodes (12): BreedPageContent(), ParentCard(), ParentSelector(), Sort, BREEDABLE_STAGES, canBattle(), canBreed(), canTrain() (+4 more)

### Community 69 - "TrainingGymShell"
Cohesion: 0.29
...
Cohesion: 0.13
Nodes (18): CameraCue, BattlePresentationState, BattlePersonality, NEUTRAL_PERSONALITY, PERSONALITIES, PersonalityArchetype, personalityForArchetype(), STYLE_TO_ARCHETYPE (+10 more)
...
### Community 79 - "ContinuousBattle"
Cohesion: 0.24
Nodes (4): ContinuousBattle(), pose(), CombatSession, TacticalMode

### Community 82 - "physicalProfile.ts"
Cohesion: 0.17
Nodes (12): ACTION_DEFINITIONS, ALL_ACTIONS, legalActions(), LOW_COMMITMENT_ACTIONS, actionDurationMs(), exchangeDurationMs(), clamp(), PhysicalProfile (+4 more)
...
### Community 111 - "combat.ts"
Cohesion: 0.14
Nodes (25): randomStatBlock(), FightOutcomeUpdate, finalHealthPercent(), healChicken(), battleReadyNpcGenerator(), generateMatchedOpponent(), totalEffectiveStats(), MAX_HEALTH (+17 more)
...
Cohesion: 0.10
Nodes (22): ACTIONS, COMBAT_DT, COMBAT_TICK_RATE, COMMAND_BUFFER_TICKS, COMMAND_COOLDOWN_TICKS, TACTICAL_MODES, TEMPORARY_COMBAT_EXAGGERATION, exits (+14 more)
...
Cohesion: 0.11
Nodes (19): ClinicDTO, PILL_TONE, RosterEntry, LiveMatchupResponse, LiveMode, LiveResolveResponse, MODE_LABEL, Phase (+11 more)
...
### Community 149 - "testHelpers.ts"
Cohesion: 0.27
Nodes (7): makeChicken(), physicalBlock(), statBlock(), seed(), context(), defaultRoosterTrainingState(), TrainingSessionIntent

### Community 150 - "animation/types.ts"
Cohesion: 0.11
Nodes (23): aerialAttack(), wingOpen(), clamp(), deriveAnimationGains(), BoneMap, flapIntensityFor(), HIT_POWER, isAttack() (+15 more)

### Community 152 - "VillageView.tsx"
Cohesion: 0.27
Nodes (9): CoopHUD(), CoopMode, CoopIcon(), IconName, PATHS, EggGrid(), VillageView(), paginateVillage() (+1 more)

### Community 153 - ".finalize"
Cohesion: 0.20
Nodes (7): fighterStrength(), gainExperience(), createInjuryRecord(), nextInjuryId(), rollCriticalInjury(), rollInjurySeverity(), commandMode()

### Community 154 - "battleDirector.ts"
Cohesion: 0.19
...
Cohesion: 0.25
Nodes (6): LOCATION_LOCKS, REHAB_LABEL, REHAB_LADDER, rehabStage(), InjuryLocation, RehabStage

### Community 156 - "StatBlock"
Cohesion: 0.12
Nodes (23): POST(), seedChicken(), statBlock(), seedChicken(), statBlock(), seedChicken(), statBlock(), effortHeadroom() (+15 more)

### Community 157 - "TournamentPage"
Cohesion: 0.38
Nodes (4): TournamentPage(), currentOpponentEntrant(), handleFight(), resolveTournamentFight()
...
### Community 160 - "math.ts"
Cohesion: 0.12
Nodes (12): BREATH_SUPPRESS, LayerRig, WingChainSpring, WingChainTarget, damp(), lerp(), smootherstep(), Spring (+4 more)
...
### Community 163 - "tournament/route.ts"
Cohesion: 0.24
Nodes (11): GET(), POST(), Activity, GET(), currentOpponent(), getTournamentDefinition(), findActiveTournament(), startTournament() (+3 more)

### Community 165 - "villageIdle.ts"
Cohesion: 0.22
Nodes (7): BASE_DURATION, STATE_SEQUENCE, VillageAnimState, VillageChickenAI, VillageIdleConfig, VillageIdleFrame, mulberry32()

### Community 166 - "liveSession.ts"
Cohesion: 0.12
Nodes (18): combatEvolutionSnapshot, COMBAT_VERSION, createMatch(), freeze(), queueCommand(), runCombatToCompletion(), validateNumbers(), createCombatRng() (+10 more)
...
### Community 169 - "pve/service.ts"
Cohesion: 0.05
Nodes (65): POST(), POST(), StepBody, POST(), GET(), BossFightPage(), nextBossName(), Phase (+57 more)

### Community 170 - "add"
Cohesion: 0.19
Nodes (25): combatBase(), plantFeet(), wingRaise(), idle(), ready(), taunt(), backstep(), legCycle() (+17 more)
...
Cohesion: 0.13
Nodes (18): OffspringOdds, WILD_RARITY_WEIGHT, WILD_TOTAL_WEIGHT, RARITY_ORDER, CALM, IRON_STAMINA, pickWeightedTrait(), RARITY_WEIGHT (+10 more)
...
### Community 199 - "tournament/[chickenId]/page.tsx"
Cohesion: 0.14
Nodes (13): Phase, PLACEMENT_LABEL, IMPORTANT:, TournamentFightStepResponse, TournamentView, CircuitStep, eligibility(), TournamentCircuitPage() (+5 more)
...
Cohesion: 0.14
Nodes (20): AWAKENINGS, clamp(), EMPTY_COMBAT_TELEMETRY, evaluateTraits(), evolveCombatCareer(), LEVEL_THRESHOLDS, SIGNATURES, TRAIT_RULES (+12 more)
...
Cohesion: 0.19
Nodes (14): applyHenOverride(), applyProportions(), applyRuntimeNeutralPose(), applyVisualTraits(), BONE_PARENT, ChickenModel(), DEFAULT_PHYSICAL_BLOCK, installPatternShader() (+6 more)

### Community 218 - "FightingStyle"
Cohesion: 0.39
Nodes (7): FightingStyle, balancedStatBlock(), baselinePhysicalBlock(), main(), PAIRS, solidColorScheme(), zeroStatBlock()

### Community 219 - "ManageView.tsx"
Cohesion: 0.49
Nodes (8): ChickenCard(), CoopSelectionPanel(), ManageView(), recommendation(), canFight(), isChampion(), canAgeUp(), canRetire()
...
### Community 221 - "animations/index.ts"
Cohesion: 0.27
Nodes (5): ANIMATIONS, AnimationStateMachine, BLEND, PRIORITY, AnimState

### Community 222 - "coopFilters.ts"
Cohesion: 0.27
Nodes (7): CoopFilters(), STATUS_OPTIONS, CoopFilterState, DEFAULT_COOP_FILTERS, filterChickens(), NO_FILTER, ChickenStatus
...
### Community 227 - "backfill-color-jitter.ts"
Cohesion: 0.73
...
### Community 229 - "CoopCamera.tsx"
Cohesion: 0.50
Nodes (3): CoopCamera(), IDLE_POS, IDLE_TARGET

### Community 230 - "Chicken"
Cohesion: 0.21
Nodes (13): POST(), POST(), POST(), createBattleSession(), createTournamentBattleSession(), endBattleSession(), getTournamentBattleSession(), sessions (+5 more)
...
## Knowledge Gaps
- **1881 isolated node(s):** `StepBody`, `Body`, `PROGRAM_BY_STAT`, `DevAction`, `BetBody` (+1876 more)
...
- **Why does `Chicken` connect `Chicken` to `BattleCanvas.tsx`, `battleReport.ts`, `chickenGenerator.ts`, `status.ts`, `live/page.tsx`, `ChickenViewer.tsx`, `testHelpers.ts`, `ContinuousBattle.tsx`, `VillageView.tsx`, `marketplace.ts`, `training.ts`, `liveCommentary.ts`, `simulator.ts`, `chicken/[chickenId]/page.tsx`, `facilities/service.ts`, `ChickenPhysicsRig.tsx`, `medical.test.ts`, `behavior.ts`, `liveSession.ts`, `spar/start/route.ts`, `pve/service.ts`, `MatchupScreen.tsx`, `coopVillage.ts`, `CombatResult`, `validation-gate-sim.ts`, `thumbnailCache.ts`, `tournament/service.ts`, `tournament.ts`, `rarity.ts`, `medical/service.ts`, `lib/types.ts`, `getOrCreatePlayer`, `simulateFight`, `growth.ts`, `tournament/[chickenId]/page.tsx`, `lib/training/types.ts`, `evolution.ts`, `physicalProfile.ts`, `TrainingGymShell.tsx`, `ChickenModel.tsx`, `ManageView.tsx`, `coopFilters.ts`, `TrainingVisualizationController.tsx`, `combat.ts`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `CombatLogEntry` connect `spar/start/route.ts` to `BattleCanvas.tsx`, `behavior.ts`, `liveSession.ts`, `Chicken`, `live/page.tsx`, `liveCommentary.ts`, `simulator.ts`, `lib/types.ts`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `BattleCanvas()` connect `BattleCanvas.tsx` to `math.ts`, `ChickenPhysicsRig.tsx`, `arenaRoam.ts`, `AudioEngine`, `combatPresentation.ts`, `combatPresentation.test.ts`, `combat.ts`, `live/page.tsx`, `physicalProfile.ts`, `liveCommentary.ts`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **What connects `StepBody`, `Body`, `PROGRAM_BY_STAT` to the rest of the system?**
...
- **Should `battleReport.ts` be split into smaller, more focused modules?**
